...
export async function getStaticPaths() {
    const response = await fetch('https://brcadv.com/api/posts')
...
export async function getStaticProps({ params }) {
    const res = await fetch(`https://brcadv.com/api/posts/${params.id}`)
    const post = await res.json()

    const resp = await fetch('https://brcadv.com/api/posts')
