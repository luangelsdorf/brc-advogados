    ...
    return (
        <div className="newsletter mx-3 mx-sm-0">
            <div>
                ...
                <span className="text-white d-none d-md-inline-block my-4">{ textos.nl_text }</span>
                <form onSubmit={ handleSubmit }>
                    <div className="input-group">
                        <input onChange={ (e) => { setEmail(e.target.value) } } required="required" type="email" className="form-control news-input" placeholder={ textos.nl_campo } />
